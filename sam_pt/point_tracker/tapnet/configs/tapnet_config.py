...
# Taken from: https://github.com/deepmind/tapnet/blob/ba1a8c8f2576d81f7b8d69dbee1e58e8b7d321e1/configs/tapnet_config.py
...
def get_config() -> config_dict.ConfigDict:
    ...
    config.checkpoint_dir = 'logs/tapnet_training/'
